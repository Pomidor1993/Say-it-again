...
import com.example.sayitagain.ui.theme.calculateSimilarity
import com.example.sayitagain.ui.theme.normalizeForComparison
...
fun GameScreen(
    ...
    LaunchedEffect(currentQuote) {
        currentQuote?.let { quote ->
            try {
                isQuoteLoaded = false
                mediaPlayerHelper.playFromFirebase(quote.code)
                isQuoteLoaded = true
            } catch (e: Exception) {
        ...
        Column(
            ...
            when {
                ...
                playbackEnded -> Row(
                    ...
                    Image(
                        painter = painterResource(id = R.drawable.responsebutton1),
...
private fun AnswerForm(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.gobackbutton),
...
private fun AnswerResultScreen(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.nextplayerbutton),
...
private fun PlayButton(onClick: () -> Unit) {
    Image(
        painter = painterResource(id = R.drawable.onlineplaybutton),
    ...
    Row(
        ...
        Image(
            painter = painterResource(
                id = if (isPlaying) R.drawable.pausebutton
                else R.drawable.onlineplaybutton
            ),
...
private fun ReplayButton(
    onReplay: () -> Unit,
    modifier: Modifier = Modifier // Dodajemy parametr modyfikatora
) {
    Image(
